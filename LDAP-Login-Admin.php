...
<div class="wrap">
    ...
    <form method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <?php if ($active_tab == "simple"): ?>
            <h3>Required</h3>
            <p>These are the most basic settings you must configure. Without these, you won't be able to use LDAP Login.</p>
            <table class="form-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('account_suffix')); ?>" value="<?php echo htmlspecialchars($LDAPLogin->get_setting('account_suffix')); ?>" /><br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('base_dn')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('base_dn')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('domain_controllers', 'array')); ?>" value="<?php echo esc_attr(join(';', (array) $LDAPLogin->get_setting('domain_controllers'))); ?>" />
            ...
            <table class="form-table" style="margin-bottom: 20px;">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('groups', 'array')); ?>" value="<?php echo esc_attr(join(';', (array) $LDAPLogin->get_setting('groups'))); ?>" /><br/>
            ...
            <table class="form-table">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('group_base_dn')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('group_base_dn')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('ol_login')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('ol_login')); ?>" />
                            <br />
                            Default: <b>uid</b>;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('ol_group')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('ol_group')); ?>" />
                            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('ldap_port')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('ldap_port')); ?>" /><br/>
                            This is usually 389.
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('ldap_version')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('ldap_version')); ?>" /><br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('login_domain')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('login_domain')); ?>" /><br/>
            ...
            <table class="form-table" style="margin-bottom: 20px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('sso_search_user')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('sso_search_user')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!$this->is_sso_enabled()) { ?>
                                ...
                                if ($bind_test) {
                                    ?>
                                    <p style="color: green">Bind OK for search user '<b><?php echo $LDAPLogin->get_setting('sso_search_user'); ?></b>'.</p>
                                    <?php
                                } else {
                                    ?>
                                    <p style="color: red">Bind failure for search user '<b><?php echo $LDAPLogin->get_setting('sso_search_user'); ?></b>'.</p>
                                    <?php
                                }
                            }
                            ?>
        ...
        <?php elseif ($active_tab == "user"): ?>
            ...
            <table class="form-table" style="margin-bottom: 20px;">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('user_first_name_attribute')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('user_first_name_attribute')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('user_last_name_attribute')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('user_last_name_attribute')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('user_email_attribute')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('user_email_attribute')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('user_url_attribute')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('user_url_attribute')); ?>" />
                            <br/>
            ...
            <p>Additional user data can be stored as user meta data. You can specify the LDAP
                ...
                <b>Keep in your mind that the final <i>wordpress_meta_key</i> will be two meta keys, using the suffixes below, like, <i>wordpress_meta_key_<?php echo $LDAPLogin->get_setting('meta_data_suffix_ldap'); ?></i> and <i>wordpress_meta_key_<?php echo $LDAPLogin->get_setting('meta_data_suffix_wp'); ?></i>.</b></p>
            ...
            <table class="form-table" style="margin-bottom: 20px;">
                <tbody>
                        ...
                        <td>
                            <textarea cols="50" name="<?php echo esc_attr($this->get_field_name('user_meta_data')); ?>"><?php
                                echo esc_html(join("\n", array_map(function ($attr) {
                                                    return join(':', $attr);
                                                }, $LDAPLogin->get_setting('user_meta_data'))));
                                ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('meta_data_suffix_ldap')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('meta_data_suffix_ldap')); ?>" />
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr($this->get_field_name('meta_data_suffix_wp')); ?>" value="<?php echo esc_attr($LDAPLogin->get_setting('meta_data_suffix_wp')); ?>" />
                            <br/>
            ...
            <?php else: ?>
            <h3>Help</h3>
            <p>Here's a brief primer on how to effectively use and test LDAP Login.</p>
            ...
            <p>If you accidentally lock yourself out, the easiest way to get back in is to rename <strong><?php echo plugin_dir_path(__FILE__); ?></strong> to something else and then refresh. WordPress will detect the change and disable LDAP Login. You can then rename the folder back to its previous name.</p>
        <?php endif; ?>
    </form>
</div>
